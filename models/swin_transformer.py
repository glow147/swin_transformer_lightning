...
class SwinTransformer(pl.LightningModule):
    ...
    def __init__(self, cfg=None, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.mixup_fn = Mixup(mixup_alpha=0.8, cutmix_alpha=1.0, cutmix_minmax=None, prob=0.8, switch_prob=0.5, mode='batch',)
